...
@onready var dialogue_label: DialogueLabel = $Panel/Margin/HBox/VBox/DialogueLabel
@onready var responses_menu: VBoxContainer = $Panel/Margin/HBox/VBox/Responses
